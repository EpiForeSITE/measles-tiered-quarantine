...
The table may be somewhat misleading since it is suggesting that strategy 2 (which is fewer days of quarantine than strategy 1) is performing better. However, looking into the distribution of total infected individuals provides a better picture of the differences between strategies:
