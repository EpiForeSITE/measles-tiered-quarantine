# Measles Tiered Quarantine Simulation – 80% Vaccination
George G. Vega Yon, Ph.D.
2025-10-23

- [Description of the model](#description-of-the-model)
- [Setup](#setup)
- [Scenario: 80% vaccination](#scenario-80-vaccination)
...
|:-----------------------|:---------|:---------|:----------|
| Strategy 1a (21,21,21) | 0.24     | 0.10     | 0.10      |
| Strategy 1b (21,21,14) | 0.25     | 0.08     | 0.08      |
| Strategy 1c (21,21,0)  | 0.31     | 0.03     | 0.02      |
| Strategy 2a (14,14,14) | 0.32     | 0.11     | 0.11      |
| Strategy 2b (14,14,7)  | 0.34     | 0.09     | 0.09      |
| Strategy 2c (14,14,0)  | 0.38     | 0.05     | 0.04      |
| Baseline (0,0,0)       | 0.64     | 0.29     | 0.14      |

Probability of outbreak sizes across different quarantine scenarios.

We can also create a figure

![](scenario-vax-0.80_files/figure-commonmark/figure-1.png)

Same figure but directly comparing strategy 1a vs strategy 2a:

![](scenario-vax-0.80_files/figure-commonmark/figure-1a-2a-1.png)
