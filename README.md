...
> [!NOTE]
> **Tables show "TBD" values**: The simulation results need to be regenerated by running `quarto render README.qmd` to populate the probability tables with actual values.
